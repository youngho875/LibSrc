...
//	m_Ellipsoid = EWGE;	// WGS84
	...
	m_pMapScale = NULL;
	m_pZoomRatio = NULL;
	m_pCoordMgr = CCoordMgr::GetInst();	//getInstance();
}
...
CGDCGeo::~CGDCGeo()
{
	...
	if(m_pCoordMgr != NULL) { CCoordMgr::ReleaseInst(); m_pCoordMgr = NULL;}
}
...
/////////////////////////////////////////////////////////////////////////////
// create object for corresponding mapping mode

/////////////////////////////////////////////////////////////////////////////

//전장상황도 CoordManager의 포인트를 설정한다
void CGDCGeo::SetCoordMgr(CCoordMgr *pCoordMgr)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());

	m_pCoordMgr->SetInst(pCoordMgr);	//setInstance(pCoordMgr);
}
